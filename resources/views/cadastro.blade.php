...
<body>
    <div class="form-container">
        ...
        <form action="{{ route('pessoa.store') }}" method="POST">
            ...
            <input type="text" name="cpf" id="cpf" placeholder="CPF (000.000.000-00)" value="{{ old('cpf') }}" required>

            <hr style="margin: 20px 0; border: 0; border-top: 1px solid #ddd;">
            <h3 style="color: #4a5568; margin-bottom: 15px; font-weight: bold;">Endereço</h3>

            <input type="text" name="cep" id="cep" placeholder="CEP (00000-000)" maxlength="9" value="{{ old('cep') }}" required>
            
            <div class="flex-container">
                <input type="text" name="rua" id="rua" readonly placeholder="Rua / Logradouro" 
                    class="flex-main bg-readonly">
                <input type="text" name="numero" id="numero" placeholder="Nº" 
                    class="flex-side" value="{{ old('numero') }}" required>
            </div>
            ...
            <div class="flex-container">
                ...
                <input type="text" name="uf" id="uf" readonly placeholder="UF" 
                    class="flex-side bg-readonly">
            </div>

            <button type="submit" style="background-color: #2d3748; margin-top: 10px;">Finalizar Cadastro</button>
        </form>
